  ...
  return (
    <Popover open={isOpen} onOpenChange={onOpenChange}>
      <PopoverTrigger asChild>
        <button className={cn("w-full h-14 px-5 flex items-center justify-between rounded-lg! border border-slate-100 dark:border-(--card-border-color) bg-white dark:bg-(--page-body-bg) hover:border-blue-200 dark:hover:border-(--card-border-color) transition-all duration-300 shadow-sm", triggerClassName)}>
