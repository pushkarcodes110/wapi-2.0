        ...
        <div className="grid lg:grid-cols-5 gap-0 items-stretch">
          ...
          <div className="bg-white lg:rounded-r-3xl shadow-2xl p-8 lg:p-10 flex flex-col justify-center relative lg:col-span-3 min-h-200">
            ...
            <div className="relative z-10 max-w-2xl mx-auto w-full">
              ...
              <div className="mb-8">
                <h2 className="text-3xl text-slate-900 mb-2">{t("register_title")}</h2>
                <p className="text-slate-600">{t("register_subtitle")}</p>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      ...
                      <Input id="fullName" name="fullName" placeholder={t("full_name_placeholder")} value={formik.values.fullName} onChange={formik.handleChange} onBlur={formik.handleBlur} className="pl-12 h-11 border border-(--input-border-color) focus:border-primary rounded-lg" />
                    </div>
                  ...
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      ...
                      <Input id="email" name="email" type="email" placeholder={t("email_placeholder")} value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} className="pl-12 h-11 border border-(--input-border-color) focus:border-primary rounded-lg" />
                    </div>
                  ...
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="pl-12 h-12 border border-slate-200 focus:border-emerald-500 rounded-lg"
                      />
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      ...
                      <Input id="password" name="password" type={showPassword ? "text" : "password"} placeholder={t("password_placeholder")} value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} className="pl-12 pr-12 h-12 border border-slate-200 focus:border-emerald-500 rounded-lg" />
                  ...
                  <div className="space-y-2 flex flex-col">
                    ...
                    <div className="relative group">
                      <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-emerald-600 transition-colors" />
                      <Input id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? "text" : "password"} placeholder={t("confirm_password_placeholder")} value={formik.values.confirmPassword} onChange={formik.handleChange} onBlur={formik.handleBlur} className="pl-12 pr-12 h-12 border border-slate-200 focus:border-emerald-500 rounded-lg" />
