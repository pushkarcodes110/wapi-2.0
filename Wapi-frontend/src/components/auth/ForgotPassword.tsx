...
export const ForgotPasswordPage = () => {
  ...
  const steps = [
    { icon: Mail, title: t("step_enter_email"), description: t("step_enter_email_desc") },
    { icon: Key, title: t("step_receive_link"), description: t("step_receive_link_desc") },
    { icon: Lock, title: t("step_reset_password"), description: t("step_reset_password_desc") },
  ];
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-emerald-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <div className="grid lg:grid-cols-5 gap-0 items-stretch">
            ...
            <div className="relative z-10 space-y-10">
              ...
              <div>
                <h2 className="text-3xl text-white leading-tight mb-4">
                  ...
                  <br />
                  <span className="text-emerald-300">{t("in_3_easy_steps")}</span>
                </h2>
                <p className="text-slate-300">{t("recovery_description")}</p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-emerald-200 text-sm font-medium mb-1">{t("security_priority")}</p>
                    <p className="text-slate-300 text-xs">{t("security_description")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white lg:rounded-r-3xl shadow-2xl p-4 sm:p-6 flex flex-col justify-center relative lg:col-span-3 min-h-162.5">
            ...
            <div className="relative z-10 max-w-lg mx-auto w-full">
              ...
              <div className="mb-8">
                <h2 className="text-3xl text-slate-900 font-bold mb-3">{t("forgot_password_title")}</h2>
                <p className="text-slate-600 text-lg">{t("forgot_password_subtitle")}</p>
              </div>
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                <div className="space-y-2 flex flex-col">
                  ...
                  <div className="relative group">
                    ...
                    <Input id="email" type="email" placeholder={t("email_placeholder")} value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} className="pl-12 h-11 border border-(--input-border-color) focus:border-primary rounded-lg text-base" />
                  </div>
                  {formik.touched.email && formik.errors.email ? <p className="text-sm text-red-500 mt-2">{formik.errors.email}</p> : <p className="text-sm text-slate-500 mt-2">{t("enter_email_help")}</p>}
                </div>
