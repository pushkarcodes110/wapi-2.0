...
export const BasicInfoSection = ({ language, setLanguage, category, setCategory, templateName, setTemplateName, marketingType, setMarketingType, offerText, setOfferText, languages, categories, isEditing }: BasicInfoSectionProps) => {
  return (
