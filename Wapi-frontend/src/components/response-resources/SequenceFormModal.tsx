      ...
      <DialogContent className="sm:max-w-md! max-w-[calc(100%-2rem)]! p-0! overflow-hidden border-none bg-white dark:bg-(--card-color) rounded-lg shadow-2xl">
        <DialogHeader className="sm:px-6 px-4 pt-6">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left rtl:text-right">
              ...
              <DialogDescription className="text-xs text-slate-400 font-medium">{editItem ? "Update your message flow name" : "Start by giving your message flow a name"}</DialogDescription>
            </div>
          </div>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="sm:p-6 p-4 pt-3 space-y-4">
          <div className="space-y-1.5">
            <Label className="text-sm font-medium text-slate-400">Message Flow Name</Label>
