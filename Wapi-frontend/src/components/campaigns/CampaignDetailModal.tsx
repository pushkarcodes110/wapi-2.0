          ...
          <div className="sm:px-6 px-4 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-(--table-hover) text-slate-400 hover:text-primary transition-all disabled:opacity-30"
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-(--table-hover) text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-all"
              >
                <X size={20} />
              </button>
            </div>
              ...
              <TabsList className="bg-transparent p-0 gap-6 dark:border-(--card-border-color) border-b border-transparent w-full justify-start h-auto">
                {CAMPAIGNDATA.map((tab) => (
                  <TabsTrigger
                    ...
                    className={`gap-2 px-0 pb-4 shadow-none! rounded-none border-b-2 ${activeTab === tab.id ? "border-slate-300 dark:border-(--card-border-color) p-2" : "border-transparent"} hover:border-slate-300 p-2 dark:hover:border-(--dark-sidebar) text-slate-400 font-bold text-sm transition-all hover:text-slate-600 dark:hover:text-slate-300`}
                  >
