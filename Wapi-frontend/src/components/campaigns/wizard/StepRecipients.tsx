...
const StepRecipients = ({
  ...
  const recipientTypes: {
  ...
  }[] = [
    {
      ...
      title: "All Contacts",
      icon: <Users size={24} />,
      description: "Send to everyone in your database",
    },
    {
    ...
    },
    {
      ...
      icon: <Hash size={24} />,
      description: "target people with specific labels",
    },
    {
      id: "segments",
      title: "Target Segments",
      icon: <Layers size={24} />,
      description: "Send to pre-defined customer segments",
    },
  ];
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="min-h-25 animate-in fade-in slide-in-from-top-4">
        ...
        {formik.values.recipient_type === "all_contacts" && (
          <AllContactsAlert count={contacts.length} />
        )}
      </div>
    </div>
  );
