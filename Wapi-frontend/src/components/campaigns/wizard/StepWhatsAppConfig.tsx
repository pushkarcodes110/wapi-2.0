      ...
      {formik.values.waba_id ? (
        <div className="space-y-6 animate-in slide-in-from-top-4 max-h-161.75 overflow-auto custom-scrollbar">
          <div className="flex items-center justify-between flex-wrap">
            ...
            <span className="text-[10px] font-bold px-2 py-1 bg-slate-100 dark:bg-(--page-body-bg) rounded-lg text-slate-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {finalTemplatesData.map((tpl: Template) => {
                ...
                return (
                  <div
                    key={tpl._id}
                    onClick={() => formik.setFieldValue("template_id", tpl._id)}
                    className={cn(
