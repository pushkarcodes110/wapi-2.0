    ...
    <div className="relative overflow-hidden rounded-lg bg-linear-to-br from-primary via-primary/95 to-primary sm:p-5 p-3 text-white shadow-2xl shadow-primary/30 flex flex-col justify-between transition-all duration-500 hover:shadow-primary/40 group">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => router.push("/manage_profile")} className="absolute -top-1 -right-1 rtl:right-[unset]! rtl:-left-1 z-10 flex items-center bg-white/15 backdrop-blur-md border border-white/20 rounded-full p-2.5 w-fit hover:bg-white/20 transition-all font-bold text-md">
