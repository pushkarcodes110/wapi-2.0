                ...
                return (
                  <div key={ws._id} className={`w-full relative group p-1`}>
                    <div
                      ...
                      className={`w-full text-start flex items-start gap-3 p-3.5 rounded-xl border transition-all duration-200 cursor-pointer ${
                        isActive ? "border-primary/80 dark:border-primary bg-primary/10 dark:bg-emerald-900/15" : "border-slate-200 dark:border-white/10 hover:border-primary/10 dark:hover:border-emerald-500/30 hover:bg-slate-50 dark:hover:bg-white/5"
                      }`}
                    >
