      ...
      <div className="flex items-center gap-4">
        {step > 1 && (
          <Button
            variant="ghost"
            onClick={handleBack}
            className="rounded-lg px-6 h-12 font-black text-slate-700 hover:text-emerald-600 bg-slate-100 dark:bg-(--card-color) hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-all flex items-center gap-2"
          >
